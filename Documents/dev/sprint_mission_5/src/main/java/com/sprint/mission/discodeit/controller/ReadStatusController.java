...
public class ReadStatusController {
    ...
    @PostMapping
    public ResponseEntity<ReadStatusResponseDto> createChannelReadStatus (@RequestParam UUID channelId, @RequestBody ReadStatusCreateDto dto) {
    ...
    public ResponseEntity<ReadStatusResponseDto> updateChannelReadStatus (@PathVariable("readStatusId") UUID readStatusId, @RequestBody ReadStatusUpdateDto dto) {
    ...
    @GetMapping
    public ResponseEntity<List<ReadStatusResponseDto>> getUserReadStatus (@RequestParam UUID userId) {
